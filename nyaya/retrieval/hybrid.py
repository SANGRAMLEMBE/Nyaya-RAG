...
class HybridRetriever:
    ...
    def retrieve(
        ...
        """Run hybrid retrieval and return up to `final_k` chunks, RRF-ranked.
        ...
        Args:
            ...
            final_k: Chunks returned after RRF merge (default: settings.rerank_top_k).
        """
        ...
        # Over-fetch to account for era filtering after BM25 (BM25 has no native era filter)
        merged_ids = self._rrf_merge(dense_ids, bm25_ids, final_k * 3)
